import pytest
import numpy as np
from Source.recording import Recording, load_file, file_path_to_experiment
...
class Test_Recording:
    ...
    def test_load_file(self, my_file_path_and_exp_name):
        signal, annotations = load_file(my_file_path_and_exp_name[0])
    ...
    def test_file_path_to_experiment(self, my_file_path_and_exp_name):
        experiment = file_path_to_experiment(my_file_path_and_exp_name[0])
